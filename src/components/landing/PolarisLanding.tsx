...
// Vitrine do produto. É server component de propósito: o HTML sai pronto do
// servidor, com texto e título, senão o buscador recebe um <body> vazio. Vive
// aqui, e não dentro de uma rota, porque duas URLs a mostram — a página inicial
// (canônica) e /polaris, que ficou como endereço antigo.
...
// software, e não um texto qualquer. Aponta para a raiz, que é a URL canônica.
const JSON_LD = {
...
export function PolarisLanding() {
  return (
