...
export function MenuPageClient() {
  ...
  return (
    <div className="min-h-screen pb-24 relative">
      <section
        className="relative w-full bg-no-repeat bg-top bg-[length:100%_auto] md:bg-[length:100%_100%] md:aspect-[1024/466] bg-[image:url('/lima-limao-bg-mobile.png')] md:bg-[image:url('/lima-limao-bg.png')]"
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 pt-[78px] md:pt-[280px] pb-6 space-y-5">
