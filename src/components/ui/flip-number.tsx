 ...
 *
 * Os dígitos mais à direita giram um pouco depois dos da esquerda, que é o que
 * dá a sensação de placar mecânico em vez de troca seca de texto.
 */
export function FlipNumber({
  ...
  return (
    <span className={cn('inline-flex tabular-nums', className)} aria-label={String(value)} role="img">
      {digitos.split('').map((digito, i) => (
        ...
        >
          ...
          <span
            ...
            style={{
              transform: `translateY(-${pronto ? Number(digito) : 0}em)`,
